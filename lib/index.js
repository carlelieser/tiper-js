...
var Tiper = /** @class */ (function () {
    function Tiper(element, options) {
        ...
        this.getWords = function () {
            return _this.options.text.match(/\w+/g);
        };
        this.getTypingSpeed = function () {
            return _this.options.text.length / (_this.options.wordsPerMinute * 4.7) + 10;
        };
        ...
        this.updateElementText = function (char) {
            ...
            var text = _this.options.text.substring(0, previousTextContent.length - (_this.options.showCaret ? 1 : 0)) + char;
            var caret = _this.options.showCaret ? _this.getCaretCharacter() : "";
            _this.element.textContent = text + caret;
        };
        this.stopTyping = function () {
            return dynamic_1.clearIntervalAsync(_this.typingInterval);
        };
        this.handleTypingPause = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.stopTyping();
                        return [4 /*yield*/, util_1.delay(this.options.pauseTimeout)];
                    case 1:
                        _a.sent();
                        this.beginTyping();
                        return [2 /*return*/];
                ...
                switch (_a.label) {
                    case 0:
                        timeout = Math.floor(this.options.hesitation *
                            Math.random() *
                            util_1.getRandomArbitrary(100, 500));
                        return [4 /*yield*/, util_1.delay(timeout)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        this.insertNextChar = function () { return __awaiter(_this, void 0, void 0, function () {
            var currentChar, nextChar, isWhitespace, isEndOfSentence, shouldPause;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        currentChar = this.options.text.charAt(this.currentIndex);
                        nextChar = this.options.text.charAt(this.currentIndex + 1);
                        isWhitespace = /\s/.test(currentChar);
                        isEndOfSentence = (/[\.\?\!]/.test(currentChar) && !/[\.\?\!]/.test(nextChar)) ||
                            /\\n/.test(currentChar);
                        shouldPause = (this.options.pauseOnSpace && isWhitespace) ||
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        randomCharPosition = util_1.getRandomArbitrary(1, text.length);
                        ...
                        return [4 /*yield*/, util_1.delay(this.options.hesitation * util_1.getRandomArbitrary(100, 200))];
                    case 1:
                        _a.sent();
        ...
        this.beginTyping = function () {
            ...
            _this.typingInterval = dynamic_1.setIntervalAsync(_this.insertNextChar, ms);
            if (_this.options.glitch)
                _this.glitchInterval = dynamic_1.setIntervalAsync(_this.applyGlitch, 5000);
