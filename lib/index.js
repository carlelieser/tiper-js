...
var Tiper = /** @class */ (function () {
    function Tiper(container, options) {
        ...
        this.getTypingSpeed = function () {
            var ms = Math.floor(_this.currentText.length / (_this.options.wordsPerMinute * 4.7) + 30);
            return ms;
        };
        ...
        this.stopTyping = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.resumeTyping = function (reverse, reset) {
            if (reset)
                ...
                switch (_a.label) {
                    case 0:
                        timeout = Math.ceil(Math.floor(this.options.hesitation *
                            Math.random() *
                            utils_1.default.getRandomArbitrary(100, 500)));
                        return [4 /*yield*/, this.delay(timeout)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
        ...
        this.insertCurrentChar = function (reverse) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.typingListener.isFinishedTyping) return [3 /*break*/, 9];
                    ...
                    case 9: return [4 /*yield*/, this.stopTyping()];
                    case 10:
                        _a.sent();
                        _a.label = 11;
        ...
        this.back = function (chars) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.stopTyping()];
                        case 1:
                            _a.sent();
                            this.resetFinishedTyping();
