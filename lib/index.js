...
var Tiper = /** @class */ (function () {
    function Tiper(container, options) {
        ...
        this.getTypingSpeed = function () {
            var ms = _this.currentText.length / (_this.options.wordsPerMinute * 4.7) + 10;
            return ms;
        };
        ...
        this.sourceTextIsTargetLength = function () {
            ...
            var textContentLength = _this.container.textContent.length - caretLength;
        ...
        this.updateElementText = function (char) {
            var previousTextContent = _this.container.textContent;
            var caretLength = _this.getCaretLength();
            var lastIndex = previousTextContent.length - caretLength;
            var text = _this.getTextByRange(0, lastIndex) + char;
            var caret = _this.options.showCaret ? _this.getCaretCharacter() : "";
            _this.container.textContent = text + caret;
        };
        ...
        this.pauseTyping = function (ms) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        timeOut = ms !== undefined ? ms : this.options.pauseTimeout;
                        this.stopTyping();
        ...
        this.setElementText = function (text) {
            _this.container.textContent = text;
        };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.delay(this.options.hesitation * this.getRandomArbitrary(100, 200))];
                    case 1:
                        _a.sent();
